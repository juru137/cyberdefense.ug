...
// Collapsible Header with indicator icon
function CollapsibleHeader({ title, isOpen, onToggle, isMobile }: { title: string; isOpen: boolean; onToggle: () => void; isMobile: boolean }) {
  return (
    ...
    >
      <span className="text-green-600 text-lg md:text-xl animate-pulse">{'>'}</span>
...
function Navbar({ onJoin, onPartner }: { onJoin: () => void; onPartner: () => void }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 px-2 sm:px-4 pt-2 sm:pt-3">
      <nav className={`border border-green-500/30 transition-all duration-300 mx-auto max-w-6xl rounded-sm ${
        scrolled 
      ...
      content: (
        <div className="space-y-4 text-sm">
          ...
          <div className="space-y-3">
            <a href={getEmailUrl(CONTACTS.recruitEmail, "JOIN CDU", "Background:%0A")} className="flex items-center gap-3 border border-green-500/40 p-4 hover:bg-green-500/10 transition-all">
            ...
            <button onClick={() => window.open(getWhatsAppUrl("Hello CDU! I'm interested in joining."), '_blank')} className="w-full flex items-center gap-3 border border-green-500/40 p-4 hover:bg-green-500/10 transition-all">
    ...
    <div className="relative min-h-screen bg-black overflow-x-hidden" style={{ fontFamily: "'Courier New', 'Fira Code', 'Source Code Pro', 'Consolas', 'Monaco', 'Lucida Console', monospace" }}>
      ...
      {showTerminal && (
        <div className="fixed inset-0 z-[100] bg-black flex items-center justify-center animate-fadeIn">
          <div className="border border-green-500/30 bg-black/95 p-5 w-[92vw] max-w-sm">
            <div className="flex items-center gap-2 mb-3 border-b border-green-500/20 pb-2">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
              <span className="text-green-400 text-xs tracking-wider">CDEF Secure Boot // v2.4.1</span>
            </div>
            <div ref={terminalRef} className="h-36 overflow-y-auto text-xs text-green-400/80 space-y-1">
      ...
      <div className="relative z-10 pt-20 md:pt-24">
        ...
        <div className="relative flex flex-col items-center justify-center px-4 pt-2 md:pt-8 pb-4 min-h-[90svh] md:min-h-[85vh]">
          <div className="text-center max-w-4xl w-full flex-1 flex flex-col justify-center">
            <div className="inline-block border border-green-500/40 px-3 py-1.5 mb-5 md:mb-6">
              <span className="text-green-500 text-xs md:text-sm tracking-[0.2em]">[ SECURE CONNECTION ESTABLISHED ]</span>
            </div>
            
            <div className="relative mb-5 md:mb-6">
              <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tight leading-none">
            ...
            <p className="text-green-500/80 text-sm md:text-xl tracking-[0.15em] mb-5 md:mb-6 h-6 md:h-10 flex items-center justify-center">
        ...
        <div className="max-w-5xl mx-auto px-4 py-10 md:py-16">
          <div className="relative border border-green-500/30 bg-black/95 p-4 md:p-8 lg:p-10 backdrop-blur">
            ...
            <div className="space-y-10 md:space-y-14 text-green-400">
              ...
              {/* About with Typewriter on Desktop */}
              <FlyInSection>
              ...
              {/* THE CDEF MANIFESTO - Independent Section with Typewriter on Desktop */}
              <FlyInSection delay={150}>
                <div className="border border-green-500/30 bg-green-500/[0.02] p-4 md:p-6">
                  ...
                  <div className="text-sm md:text-base text-green-400/70">
                    {/* Desktop: Sequential Typewriter, Mobile: Static text */}
                    {!isMobile ? (
                      <SequentialTypewriter 
